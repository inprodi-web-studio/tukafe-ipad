                                  ...
                                  children: [
                                                                  ...
                                                                  decoration:
                                                                    ...
                                                                    image:
                                                                      ...
                                                                      image:
                                                                        ...
                                                                        '${FFAppConstants.BaseURL}${mainCategoryItem.categoryPhoto}',
                                                                      ),
                                                                    ),
                                                                    borderRadius:
                                                                        BorderRadius.circular(
                                    ...
                                    if (_model.path == 'categories')
                                      Padding(
                                        ...
                                        child: FutureBuilder<ApiCallResponse>(
                                          future:
                                              ProductsGroup.productsCall.call(),
                                          builder: (context, snapshot) {
                                            // Customize what your widget looks like when it's loading.
                                            if (!snapshot.hasData) {
                                              return Center(
                                            ...
                                            final mainProductsProductsResponse =
                                                snapshot.data!;
                                                          ...
                                                          onPressed: () async {
                                                            if ((functions
                                                              ...
                                                              if (confirmDialogResponse) {
                                                                FFAppState().removeFromOrderItems(FFAppState()
                                                                    .OrderItems
                                                                    .where((e) =>
                                                                        e.isFree)
                                                                    .toList()
                                        ...
                                        if (() {
                                            ...
                                            (() {
                                                      if ((FFAppState()
                                                          ...
                                                          (FFAppState()
                                                                  ...
                                                                  .length ==
                                                              0)) {
                                                        return (functions.sumUnitaryPrices(
                                                                FFAppState()
                                                                    .OrderItems
                                                                    .where((e) =>
                                                                        e.isFree ==
                                          ...
                                          _model.purchasesOutput =
                                              await ZettlePurchaseGroup
                                                  .getPurchasesCall
                                                  .call(
                                            token: ZettleAuthGroup.getTokenCall
                                                .token(
